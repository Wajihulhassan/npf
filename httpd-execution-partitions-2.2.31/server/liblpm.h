...
unsigned char * lpm_unit_start(const char * id){
	    ...
	    char benchmark_cmd[100];
    	    ...
    	    time_to_unit_start_begin = get_time();

	    // typedef unsigned char uuid_t[16];
	    unsigned char * uuid = malloc(16);
	    ...
	    free(msg);
    	    ...
    	    time_to_unit_start_finish=get_time();
...
void lpm_unit_end(uuid_t uuid){
	    ...
	    char benchmark_cmd[100];
    	    ...
    	    time_to_unit_end_begin = get_time();
	    ...
	    printf("%s: End of unit of work for id %lu\n",__func__,msg->msg.cred_id);
	    ...
	    free(msg);
    	    ...
    	    time_to_unit_end_finish = get_time();
